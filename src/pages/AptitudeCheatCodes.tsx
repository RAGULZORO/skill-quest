                ...
                >
                  <CardHeader className="pb-3">
                    <CardTitle className="text-lg font-semibold text-foreground flex items-center gap-2">
                      <span className={`w-8 h-8 rounded-full ${selectedCategory.color} flex items-center justify-center text-sm text-white font-bold`}>
                        {idx + 1}
                      </span>
                      {formula.title}
                    </CardTitle>
                  ...
                  <CardContent className="space-y-4">
                    {/* Main Formula */}
                    <div className="bg-primary/10 rounded-xl p-4 font-mono text-base text-foreground border border-primary/20">
                      {formula.formula}
                    </div>
                        ...
                        <ul className="space-y-1">
                          {formula.steps.map((step, i) => (
                            <li key={i} className="text-sm text-foreground/75 flex items-start gap-2">
                              <span className="text-foreground/85 font-medium">{step}</span>
                            </li>
                          ))}
                        </ul>
                      </div>
