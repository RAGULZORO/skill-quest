      ...
      <main className="container mx-auto px-4 py-8 max-w-6xl">
        {loading ? (
          ...
          <div className="space-y-8">
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <span className={`ml-2 text-xs px-2 py-0.5 rounded-full ${getTypeColor(item.type)}`}>
                                {item.type}
                              </span>
                            </div>
                          </div>
            ...
            {/* Performance Legend */}
            <div className="flex flex-wrap items-center justify-center gap-6 text-sm text-muted-foreground p-4 bg-muted/30 rounded-xl">
